# Public Key
Represents a Galactrum public key and is needed to be able to receive funds, as is usually represented as a Galactrum [Address](address.md).

A PublicKey in Galactrum is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK2 = new galactrum.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = galactrum.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
